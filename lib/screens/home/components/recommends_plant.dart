...
class RecommendPlantPart extends StatelessWidget {
  const RecommendPlantPart({
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color:Colors.white,
              boxShadow:[ BoxShadow(blurRadius:50,offset: Offset(0, 10),color: kPrimaryColor.withOpacity(0.23))]
